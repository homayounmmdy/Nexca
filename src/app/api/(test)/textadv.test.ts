...
import { GET, POST } from '@/app/api/textadv/route';
...
describe('TextAdv Route', () => {
   ...
   it('should call RequestHandler.Post with request', async () => {
      const req = new Request('http://localhost/api/textadv', {
         method: 'POST',
         body: JSON.stringify({ formData: { content: 'Special offer!' } }),
      });
